...
COUNTY = ((0, "Antrim"), (1, "Armagh"), (2, "Carlow"), (3, "Cavan"),
          ...
          (13, "Kildare"), (14, "Kilkenny"), (15, "Laois"), (16, "Leitrim"),
          (17, "Limerick"), (18, "Longford"), (19, "Louth"), (20, "Mayo"),
          (21, "Meath"), (22, "Monaghan"), (23, "Offaly"), (24, "Roscommon"),
          (25, "Sligo"), (26, "Tipperary"), (27, "Tyrone"), (28, "Waterford"),
...
class User(AbstractUser):
    ...
    pound_official_name = models.CharField(max_length=150,
                                           default='To be populated',
                                           unique=False)
    rescue_official_name = models.CharField(max_length=150,
                                            default='To be populated',
                                            unique=False)
    county = models.IntegerField(choices=COUNTY, default=0)


STATUS = ((0, "Hold"), (1, "Available"), (2, "Booked"),
          (3, "Transferred to Rescue"), (4, "Rehomed"),
          (5, "Reclaimed"), (6, "PTS"), (7, "Death Natural Causes"),
          (8, "Booking Proposed"))
...
class Profile(models.Model):
    ...
    pound = models.ForeignKey(User, on_delete=models.CASCADE,
                              related_name='pound_name')
...
class Booking(models.Model):
    ...
    rescue = models.ForeignKey(User, on_delete=models.CASCADE,
                               related_name='rescue_name')
